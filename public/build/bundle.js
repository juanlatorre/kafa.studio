    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text("\r\n    mi nombre es\r\n    ");
    			span = element("span");
    			span.textContent = "Juan";
    			t3 = space();
    			p = element("p");
    			p.textContent = "Soy un desarrollador front end y móvil de Chile, ayudando a personas y\r\n    empresas a entregar hermosas e intuitivas experiencias digitales a través de\r\n    buenas prácticas, investigación y experiencia.";
    			t5 = space();
    			div0 = element("div");
    			a = element("a");
    			a.textContent = "Un poco más sobre mi";
    			add_location(br, file$3, 62, 4, 3177);
    			attr_dev(span, "id", "bio");
    			attr_dev(span, "class", "brush-pink text-white svelte-sysk0m");
    			add_location(span, file$3, 64, 4, 3207);
    			attr_dev(h1, "class", "font-bold text-3xl lg:text-4xl text-blacky svelte-sysk0m");
    			add_location(h1, file$3, 60, 2, 3105);
    			attr_dev(p, "class", "nunito max-w-sm lg:max-w-md mt-10 lg:mt-16 text-md text-blacky\r\n    lg:text-xl svelte-sysk0m");
    			add_location(p, file$3, 66, 2, 3276);
    			attr_dev(a, "href", "##");
    			attr_dev(a, "class", "-ml-8 nunito text-black-jaan font-bold brush-yellow svelte-sysk0m");
    			add_location(a, file$3, 74, 4, 3617);
    			attr_dev(div0, "class", "mt-4");
    			add_location(div0, file$3, 73, 2, 3593);
    			attr_dev(div1, "class", "relative px-6 lg:px-24 svelte-sysk0m");
    			add_location(div1, file$3, 59, 0, 3065);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$7, 10, 0, 276);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
